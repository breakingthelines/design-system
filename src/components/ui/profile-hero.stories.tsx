...
export const Default = meta.story({
  args: {
    ...
    handle: 'zachlowy',
    verified: true,
    bio: 'Co-creator of @btlvid . Words for @theScore, @NICETYo, @90minUSV, @iraqgoalsports, @ReissxMUFC and @BBCWorld.',
    socialLinks: [
...
export const Following = meta.story({
  args: {
    ...
    handle: 'zachlowy',
    verified: true,
    bio: 'Co-creator of @btlvid . Words for @theScore.',
    followers: 65200,
    subscribers: 102,
    onFollow: () => {},
    onSubscribe: () => {},
...
export const Minimal = meta.story({
  args: {
    ...
    initials: 'NC',
    handle: 'newcreator',
    bio: 'Just getting started with football analytics.',
    followers: 12,
    onFollow: () => {},
  },
});
