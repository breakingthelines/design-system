...
export const COUNTRY_ISO2: Readonly<Record<string, string>> = {
  ...
  macedonia: 'mk', 'northern ireland': 'gb-nir', norway: 'no', poland: 'pl',
  portugal: 'pt', 'republic of ireland': 'ie', ireland: 'ie', romania: 'ro',
  ...
  // CONCACAF
  canada: 'ca', 'costa rica': 'cr', cuba: 'cu', curacao: 'cw', 'el salvador': 'sv',
  guatemala: 'gt', haiti: 'ht', honduras: 'hn', jamaica: 'jm', mexico: 'mx',
  panama: 'pa', 'trinidad and tobago': 'tt', 'united states': 'us', usa: 'us',
  'united states of america': 'us',
  // CAF
  algeria: 'dz', angola: 'ao', benin: 'bj', 'burkina faso': 'bf', burundi: 'bi',
  cameroon: 'cm', 'cape verde': 'cv', 'cabo verde': 'cv', 'central african republic': 'cf',
  chad: 'td', comoros: 'km', congo: 'cg', 'dr congo': 'cd', 'democratic republic of the congo': 'cd',
  'congo dr': 'cd', 'ivory coast': 'ci', "cote d ivoire": 'ci', egypt: 'eg',
  'equatorial guinea': 'gq', eritrea: 'er', ethiopia: 'et', gabon: 'ga', gambia: 'gm',
  ...
  niger: 'ne', nigeria: 'ng', rwanda: 'rw', senegal: 'sn', 'sierra leone': 'sl',
  ...
  china: 'cn', 'china pr': 'cn', 'hong kong': 'hk', india: 'in', indonesia: 'id',
  iran: 'ir', 'ir iran': 'ir', iraq: 'iq', japan: 'jp', jordan: 'jo', kuwait: 'kw',
  kyrgyzstan: 'kg', lebanon: 'lb', malaysia: 'my', myanmar: 'mm', nepal: 'np',
  'north korea': 'kp', 'korea dpr': 'kp', oman: 'om', palestine: 'ps', pakistan: 'pk',
  philippines: 'ph', qatar: 'qa', 'saudi arabia': 'sa', singapore: 'sg',
  'south korea': 'kr', 'korea republic': 'kr', 'sri lanka': 'lk', syria: 'sy',
  tajikistan: 'tj', thailand: 'th', turkmenistan: 'tm', 'united arab emirates': 'ae',
  uae: 'ae', uzbekistan: 'uz', vietnam: 'vn', yemen: 'ye',
  // OFC
  fiji: 'fj', 'new zealand': 'nz', 'papua new guinea': 'pg',
};
